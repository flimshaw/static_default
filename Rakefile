...
namespace :local do 
  ...
  task :coffee do |t, args|
    ...
    system('coffee -o public/js/src/ --join app.js -cw app/rabbit/coffeescripts/models.coffee app/rabbit/coffeescripts/collections.coffee app/rabbit/coffeescripts/views.coffee app/rabbit/coffeescripts/util.coffee app/rabbit/coffeescripts/routers.coffee app/rabbit/coffeescripts/app.coffee & coffee -o public/js/spec/ -cw app/rabbit/coffeescripts/spec/ &')
    puts "*** Done! ***"
  end
